...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($requestData['FirstName']) && isset($requestData['Lastname']) && isset($requestData['Street'])
    && isset($requestData['Suburb']) && isset($requestData['State']) && isset($requestData['Email_Address'])
    && isset($requestData['Mobile_Number'])) {
        ...
        try {
            ...
            $sql = "UPDATE user SET Quantity_Available = Quantity_Available - ? WHERE Name = ?";
